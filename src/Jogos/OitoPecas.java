...
public class OitoPecas implements Jogo {
	
	Random num = new Random();
	
	// Movimentos possíveis (definidos por index)
	...
	public ArrayList<Jogo> funcaoSucessora(int op) {
		...
		// Criação de um ArrayList a partir da lista retornada para dar um shuffle
	...
	// Movimenta o 0 de acordo com a orienação passada
